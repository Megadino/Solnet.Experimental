...
The [Solnet.Examples](https://github.com/brunopedrazza/Solnet/tree/master/src/Solnet.Examples/) project contains some code examples,
...
The [Solnet.Wallet](https://github.com/brunopedrazza/Solnet/tree/master/src/Solnet.Wallet/) project implements wallet and key generation features, these were made compatible
...
The [Solnet.KeyStore](https://github.com/brunopedrazza/Solnet/tree/master/src/Solnet.KeyStore/) project implements functionality to be able to securely store keys, seeds,
...
The [Solnet.Rpc](https://github.com/brunopedrazza/Solnet/tree/master/src/Solnet.Rpc/) project contains a full-fidelity implementation of the [Solana JSON RPC](https://docs.solana.com/developing/clients/jsonrpc-api), this implementation is compatible
...
The [Solnet.Programs](https://github.com/brunopedrazza/Solnet/tree/master/src/Solnet.Programs/) project contains our implementation of several Native and SPL programs,
for brevity, they are not exemplified in depth here, but you should check out [Solnet.Examples](https://github.com/brunopedrazza/Solnet/tree/master/src/Solnet.Examples/) which contains numerous examples,
...
This project is licensed under the MIT License - see the [LICENSE](https://github.com/brunopedrazza/Solnet/blob/master/LICENSE) file for details
